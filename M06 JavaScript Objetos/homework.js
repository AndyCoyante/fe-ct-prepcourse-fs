...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   if (objetoMisterioso.hasOwnProperty("numeroMisterioso")) {
      ...
      return "La propiedad 'numeroMisterioso' no está presente en el objeto.";
   }
}
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   if (objetoUsuario.hasOwnProperty("posts") && Array.isArray(objetoUsuario.posts)) {
      ...
      return "La propiedad 'posts' no está presente o no es un arreglo en el objeto de usuario.";
   }
}
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   if (
      ...
      return "Las propiedades 'precio' y 'porcentajeDeDescuento' deben estar presentes en el objetoProducto.";
   }
}
